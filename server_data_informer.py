...
def prepare_data():
    all_servers_dataframe = load_json_data('1_allservers.txt')
    sessions_list = load_csv_data_like_json('2_sessions.txt', delimeter='\t')
    users_dataframe = load_json_data('3_users.txt')
